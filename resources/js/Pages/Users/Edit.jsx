            ...
            <div className="px-4 sm:px-6 py-6">
                <div className="max-w-2xl mx-auto">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <h1 className="text-2xl font-bold text-hpText">Edit User</h1>
                    </div>
                    ...
                    <div className="bg-hpBg2 border border-hpBorder rounded-xl p-6">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                <label className="block text-sm font-medium text-hpText2 mb-2">
                                    Password <span className="text-hpText3 text-xs">(leave blank to keep current)</span>
                                </label>
                                <input
                                    type="password"
                                    value={data.password}
