...
export default function Create({ domain }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('redirects.store', domain.id));
    };
        ...
        <AuthenticatedLayout
            header={
                <h2 className="font-semibold text-xl text-hpText leading-tight">
                    Add Redirect Rule - {domain.domain_name}
                </h2>
            }
        >
            <div className="py-12">
                        ...
                        <div className="p-6">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-hpMuted">The path to redirect from (e.g., /old-page, /blog/*)</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-hpMuted">The URL to redirect to</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-hpMuted">
                                        301 for permanent redirects (SEO friendly), 302 for temporary
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-hpMuted">Lower number = higher priority (0 = highest)</p>
                                </div>
                                ...
                                <div className="flex justify-end gap-3">
                                    ...
                                    >
                                        {processing ? 'Saving...' : 'Save Redirect Rule'}
                                    </button>
                                </div>
                            </form>
                        </div>
