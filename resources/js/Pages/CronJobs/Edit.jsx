...
export default function Edit({ cronJob }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('cron-jobs.update', cronJob.id));
    };
            ...
            <div className="px-4 sm:px-6 py-6">
                <div className="max-w-2xl mx-auto">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <h1 className="text-2xl font-bold text-hpText">Edit Cron Job</h1>
                    </div>
                    ...
                    <div className="bg-hpBg2 border border-hpBorder rounded-xl p-6">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex items-center justify-end gap-3">
                                ...
                                >
                                    {processing ? 'Updating...' : 'Update Cron Job'}
                                </button>
                            </div>
                        </form>
                    </div>
